...
| Surface water | [JRC Global Surface Water v1.5](https://global-surface-water.appspot.com/download) | Primary 1984–2024 observed water occurrence/change evidence plus 2024 seasonality; reservoirs and modern alterations follow the explicit reconstruction policy. |
...
| Taxonomy and occurrences | [GBIF](https://www.gbif.org/publishing-data), [iNaturalist Open Range Maps](https://www.inaturalist.org/pages/range_maps), and [OBIS](https://www.obis.org/) | GBIF/OBIS DOI-pinned, record-licensed occurrence evidence; iNaturalist's CC BY version-pinned modeled range maps for terrestrial/freshwater candidate presence; retain only CC0/CC BY evidence. Occurrences and modeled ranges are not abundance. |
| Faunal abundance calibration | [TetraDENSITY v1](https://nora.nerc.ac.uk/id/eprint/520429/) | CC BY, sparse georeferenced terrestrial-vertebrate density observations. It calibrates uncertainty-bounded initial cohorts; it is not a global census. |
