  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "After sign-in is enabled, the service stores the identity provider, its stable account identifier, an optional verified email address, and timestamps. Session, CSRF, OAuth state, nonce, PKCE, and browser-binding secrets are stored only as hashes.",
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "Processors may include Apple or Google only after a visitor chooses sign-in, and Stripe only after a visitor chooses payment. Third-party scientific-source links receive a normal web request only if a visitor follows the link. Remote simulation cognition is operationally separate from observer traffic.",
      ],
    },
    {
      heading: "Retention and requests",
      paragraphs: [
        "Browser sessions, once enabled, expire after 30 days and can be revoked. Security and transaction evidence is retained only as reasonably necessary for service operation, fraud prevention, accounting, disputes, and legal obligations. Public aliases may remain in an archived record, although an abusive or privacy-invasive alias can be hidden without rewriting world history.",
