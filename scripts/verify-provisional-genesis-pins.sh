...
grep -q -- '--ruleset-version "${ruleset_version}"' scripts/initialize-provisional-world.sh
grep -q -- 'ATINY_LAUNCH_RULESET_VERSION:-42' scripts/initialize-provisional-world.sh
...
grep -qF 'derive provisional-origin-climate-normals' scripts/prepare-provisional-genesis.sh
grep -qF 'derive provisional-origin-climate-normals' scripts/initialize-provisional-world.sh
grep -qF -- '--provisional-origin-climate-evidence "${origin_climate}"' \
  scripts/initialize-provisional-world.sh
grep -qF -- '--provisional-origin-climate-normals "${origin_climate_normals}"' \
  scripts/initialize-provisional-world.sh
...
echo "Current provisional genesis pins one verified composition and artifact revision."
