...
grep -q -- '--ruleset-version 23' scripts/initialize-provisional-world.sh
echo "Ruleset-23 provisional genesis pins one verified composition and artifact revision."
