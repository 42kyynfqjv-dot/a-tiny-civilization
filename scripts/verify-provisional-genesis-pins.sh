...
grep -q -- '--ruleset-version 31' scripts/initialize-provisional-world.sh
...
echo "Ruleset-31 provisional genesis pins one verified composition and artifact revision."
