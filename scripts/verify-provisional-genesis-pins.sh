...
grep -q -- '--ruleset-version 22' scripts/initialize-provisional-world.sh
echo "Ruleset-22 provisional genesis pins one verified composition and artifact revision."
