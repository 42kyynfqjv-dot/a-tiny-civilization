...
grep -q -- '--ruleset-version 24' scripts/initialize-provisional-world.sh
echo "Ruleset-24 provisional genesis pins one verified composition and artifact revision."
