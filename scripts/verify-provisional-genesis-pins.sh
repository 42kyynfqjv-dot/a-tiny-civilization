...
grep -q -- '--ruleset-version 25' scripts/initialize-provisional-world.sh
echo "Ruleset-25 provisional genesis pins one verified composition and artifact revision."
