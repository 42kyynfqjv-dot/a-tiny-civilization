...
grep -q -- '--ruleset-version 28' scripts/initialize-provisional-world.sh
...
echo "Ruleset-28 provisional genesis pins one verified composition and artifact revision."
