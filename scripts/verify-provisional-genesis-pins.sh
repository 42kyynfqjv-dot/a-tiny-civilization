...
grep -q -- '--ruleset-version 29' scripts/initialize-provisional-world.sh
...
echo "Ruleset-29 provisional genesis pins one verified composition and artifact revision."
