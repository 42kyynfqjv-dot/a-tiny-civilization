...
admission_file="${ATINY_QUALITY_ADMISSION_FILE:-${project_root}/docs/operations/QUALITY_WORLD_ADMISSION_RULESET32_2026-08-09.json}"
observatory_admission_file="${ATINY_PUBLIC_OBSERVATORY_ADMISSION_FILE:-${project_root}/docs/operations/PUBLIC_OBSERVATORY_ADMISSION_RULESET33_2026-08-25.json}"
