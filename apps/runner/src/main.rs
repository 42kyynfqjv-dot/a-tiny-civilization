...
use sim_engine::{
    ...
    MATERIAL_RESERVOIR_RULESET_VERSION, MOVEMENT_DIRECTION_LEARNING_RULESET_VERSION,
...
const DEFAULT_PROVISIONAL_RULESET_VERSION: u32 = MOVEMENT_DIRECTION_LEARNING_RULESET_VERSION;
...
mod tests {
    ...
    fn provisional_full_earth_defaults_to_the_source_backed_environment_ruleset() {
        ...
        assert_eq!(ruleset_version, MOVEMENT_DIRECTION_LEARNING_RULESET_VERSION);
    }
