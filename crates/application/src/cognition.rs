...
pub const LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V10: u16 = 10;
...
pub const LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V12: u16 = 12;
pub const LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V13: u16 = 13;
pub const CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION: u16 = 14;
pub const LEGACY_CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION_V4: u16 = 4;
pub const CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION: u16 = 5;
...
impl CognitionProviderId {
    ...
    #[must_use]
    pub fn hetzner_experiments() -> Self {
        Self::known("hetzner_experiments")
    }

    #[must_use]
    pub fn deterministic_research() -> Self {
        Self::known("deterministic_research")
    }
...
impl CognitionModelRoute {
    ...
    #[must_use]
    pub fn openrouter_cancer_gpt_oss_20b_free() -> Self {
        Self {
    ...
    #[must_use]
    pub fn hetzner_qwen3_6_35b_a3b_fp8() -> Self {
        Self {
            provider: CognitionProviderId::hetzner_experiments(),
            requested_model: "Qwen/Qwen3.6-35B-A3B-FP8".to_owned(),
            billing_class: CognitionBillingClass::FreeAllocation,
        }
    }

    #[must_use]
    pub fn deterministic_systematic_screen_v1() -> Self {
        Self {
            provider: CognitionProviderId::deterministic_research(),
            requested_model: "systematic-screen-v1".to_owned(),
            billing_class: CognitionBillingClass::FreeAllocation,
        }
    }

    #[must_use]
    pub fn openrouter_cancer_gpt_oss_120b_free() -> Self {
        Self {
            provider: CognitionProviderId::openrouter_cancer(),
            requested_model: "openai/gpt-oss-120b:free".to_owned(),
            billing_class: CognitionBillingClass::FreeAllocation,
    ...
    #[must_use]
    pub fn openrouter_cancer_nemotron_3_super_free() -> Self {
        Self {
            provider: CognitionProviderId::openrouter_cancer(),
            requested_model: "nvidia/nemotron-3-super-120b-a12b:free".to_owned(),
            billing_class: CognitionBillingClass::FreeAllocation,
        }
    }

    #[must_use]
    pub fn openrouter_cancer_lfm_2_5_2_6b_free() -> Self {
        Self {
            provider: CognitionProviderId::openrouter_cancer(),
            requested_model: "liquid/lfm-2.5-2.6b:free".to_owned(),
            billing_class: CognitionBillingClass::FreeAllocation,
        }
    }
    ...
    #[must_use]
    pub fn fireworks_cancer_nemotron_lightning_3_5() -> Self {
        Self {
            provider: CognitionProviderId::fireworks_cancer(),
            requested_model: "accounts/fireworks/models/nemotron-lightning-3p5-30b-a3b".to_owned(),
            billing_class: CognitionBillingClass::PaidApproved,
        }
    }
    ...
    pub fn validate(&self) -> Result<(), CognitionContractError> {
        ...
        let allowed = match (self.provider.as_str(), self.billing_class) {
            ...
            ("hetzner_experiments", CognitionBillingClass::FreeAllocation) => {
                self.requested_model == "Qwen/Qwen3.6-35B-A3B-FP8"
            }
            ("deterministic_research", CognitionBillingClass::FreeAllocation) => {
                self.requested_model == "systematic-screen-v1"
            }
...
pub struct CognitionRouteRegistry {
    ...
    pub quarantined_routes: Vec<CognitionModelRoute>,
}

impl CognitionRouteRegistry {
    fn production_routes() -> Vec<CognitionModelRoute> {
        let mut routes = vec![
    ...
    fn production_quarantined_routes() -> Vec<CognitionModelRoute> {
        vec![
            CognitionModelRoute::openrouter_gpt_oss_20b_free(),
            CognitionModelRoute::openrouter_gpt_oss_120b_free(),
    ...
    pub fn production_default() -> Self {
        Self {
            ...
            quarantined_routes: Self::production_quarantined_routes(),
        }
    }

    #[must_use]
    pub fn production_legacy_v2() -> Self {
        Self {
            policy_version: LEGACY_COGNITION_ROUTE_POLICY_VERSION,
            routes: Self::production_routes(),
    ...
    #[must_use]
    pub fn route_is_quarantined(&self, route: &CognitionModelRoute) -> bool {
        self.quarantined_routes.contains(route)
    }
    ...
    pub fn cancer_research_exploration() -> Self {
        // Live route telemetry showed that the old pinned free slugs and the
        // Hetzner endpoint were consuming nearly every request while producing
        // no useful receipts. Start with OpenRouter's maintained free router;
        // then use the deterministic closed-lab adapter for tasks it can execute
        // before trying separately configured free providers or paid overflow.
        let mut routes = vec![
        ...
        routes.push(CognitionModelRoute::fireworks_cancer_nemotron_lightning_3_5());
        Self {
    ...
    #[must_use]
    pub fn cancer_research_exploration_legacy_v13() -> Self {
        let mut routes = vec![
            CognitionModelRoute::openrouter_cancer_free(),
            CognitionModelRoute::deterministic_systematic_screen_v1(),
        ];
        ...
        Self {
            policy_version: LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V13,
            routes,
            quarantined_routes: Vec::new(),
        }
    }
    ...
    #[must_use]
    pub fn cancer_research_exploration_legacy_v12() -> Self {
        let mut routes = vec![
        ...
        routes.push(CognitionModelRoute::fireworks_cancer_gpt_oss_20b());
        Self {
            policy_version: LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V12,
            routes,
            quarantined_routes: Vec::new(),
        }
    }
    ...
    #[must_use]
    pub fn cancer_research_exploration_legacy_v10() -> Self {
        let mut routes = vec![
            CognitionModelRoute::openrouter_cancer_gpt_oss_20b_free(),
            CognitionModelRoute::openrouter_cancer_nemotron_3_super_free(),
            CognitionModelRoute::openrouter_cancer_lfm_2_5_2_6b_free(),
    ...
    #[must_use]
    pub fn cancer_research_exploration_legacy_v9() -> Self {
        let mut routes = vec![
            CognitionModelRoute::openrouter_cancer_gpt_oss_20b_free(),
            CognitionModelRoute::openrouter_cancer_free(),
    ...
    #[must_use]
    pub fn cancer_research_exploration_legacy_v8() -> Self {
        Self {
            policy_version: LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V8,
            routes: vec![
                CognitionModelRoute::openrouter_cancer_gpt_oss_20b_free(),
                CognitionModelRoute::openrouter_cancer_free(),
    ...
    pub fn cancer_research_for_policy(
        ...
        match (purpose, policy_version) {
            ...
            (
                CognitionRoutePurpose::CancerResearchExploration,
                LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V12,
            ) => Ok(Self::cancer_research_exploration_legacy_v12()),
            (
                CognitionRoutePurpose::CancerResearchExploration,
                LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V13,
            ) => Ok(Self::cancer_research_exploration_legacy_v13()),
            (
                CognitionRoutePurpose::CancerResearchExploration,
            ...
            ) => Ok(Self::cancer_research_exploration_legacy_v8()),
            (
                CognitionRoutePurpose::CancerResearchExploration,
                LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V9,
            ) => Ok(Self::cancer_research_exploration_legacy_v9()),
            (
                CognitionRoutePurpose::CancerResearchExploration,
                LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V10,
            ) => Ok(Self::cancer_research_exploration_legacy_v10()),
            (
                CognitionRoutePurpose::CancerResearchEscalation,
                LEGACY_CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION_V4,
            ) => Ok(Self::cancer_research_escalation_legacy_v4()),
            (
                CognitionRoutePurpose::CancerResearchEscalation,
    ...
    #[must_use]
    pub fn cancer_research_escalation_legacy_v4() -> Self {
        Self {
            policy_version: LEGACY_CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION_V4,
            routes: vec![
                CognitionModelRoute::openrouter_cancer_deepseek_v4_pro(),
                CognitionModelRoute::openrouter_cancer_deepseek_v4_flash(),
            ],
    ...
    pub fn validate(&self, purpose: CognitionRoutePurpose) -> Result<(), CognitionContractError> {
        let supported_policy_version = match purpose {
            ...
            CognitionRoutePurpose::CancerResearchEscalation => matches!(
                self.policy_version,
                LEGACY_CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION_V4
                    | CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION
            ),
        ...
        let expected_quarantined_routes = match (purpose, self.policy_version) {
            (
        ...
        match purpose {
            ...
            CognitionRoutePurpose::CancerResearchExploration => {
                let expected = match self.policy_version {
                    ...
                    LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V8 => vec![
                        CognitionModelRoute::openrouter_cancer_gpt_oss_20b_free(),
                        CognitionModelRoute::openrouter_cancer_free(),
                        CognitionModelRoute::fireworks_cancer_gpt_oss_20b(),
                    ],
                    LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V9 => {
                        Self::cancer_research_exploration_legacy_v9().routes
                    }
                    LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V10 => {
                    ...
                    LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V12 => {
                        Self::cancer_research_exploration_legacy_v12().routes
                    }
                    LEGACY_CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION_V13 => {
                        Self::cancer_research_exploration_legacy_v13().routes
                    }
                    CANCER_RESEARCH_EXPLORATION_ROUTE_POLICY_VERSION => {
            ...
            CognitionRoutePurpose::CancerResearchEscalation => {
                let expected = match self.policy_version {
                    LEGACY_CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION_V4 => {
                        Self::cancer_research_escalation_legacy_v4().routes
                    }
                    CANCER_RESEARCH_ESCALATION_ROUTE_POLICY_VERSION => {
                        Self::cancer_research_escalation().routes
                    }
                    _ => unreachable!("unsupported policy was rejected above"),
                };
                if self.routes != expected {
...
mod tests {
    ...
    fn production_registry_has_capacity_without_relaxing_route_approval() {
        ...
        let legacy = CognitionRouteRegistry::production_legacy_v2();
        assert_eq!(legacy.routes, registry.routes);
        assert!(legacy.quarantined_routes.is_empty());
        assert_eq!(
            legacy.validate(CognitionRoutePurpose::ProductionWorld),
            Ok(())
        );
        assert_eq!(
            CognitionRouteRegistry::production_for_policy(legacy.policy_version),
            Ok(legacy.clone())
        );
        let legacy_json = serde_json::to_value(&legacy).expect("legacy registry JSON");
        assert!(legacy_json.get("quarantined_routes").is_none());
        let decoded_legacy: CognitionRouteRegistry =
            serde_json::from_value(legacy_json).expect("decode version-two registry JSON");
        ...
        unquarantined.quarantined_routes.clear();
        assert_eq!(
            unquarantined.validate(CognitionRoutePurpose::ProductionWorld),
            Err(CognitionContractError::InvalidRouteRegistry)
        );
    ...
    fn cancer_registries_separate_free_exploration_from_paid_escalation() {
        ...
        let legacy_v13 = CognitionRouteRegistry::cancer_research_exploration_legacy_v13();
        assert_eq!(
            legacy_v13.validate(CognitionRoutePurpose::CancerResearchExploration),
            Ok(())
        );
        assert_eq!(
            legacy_v13.routes.last(),
            Some(&CognitionModelRoute::fireworks_cancer_gpt_oss_20b())
        );
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchExploration,
                legacy_v13.policy_version,
            ),
            Ok(legacy_v13)
        );
        let legacy_v12 = CognitionRouteRegistry::cancer_research_exploration_legacy_v12();
        assert_eq!(
            legacy_v12.validate(CognitionRoutePurpose::CancerResearchExploration),
            Ok(())
        );
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchExploration,
                legacy_v12.policy_version,
            ),
            Ok(legacy_v12)
        );
        let legacy_v10 = CognitionRouteRegistry::cancer_research_exploration_legacy_v10();
        assert_eq!(
            legacy_v10.validate(CognitionRoutePurpose::CancerResearchExploration),
            Ok(())
        );
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchExploration,
                legacy_v10.policy_version,
            ),
            Ok(legacy_v10)
        );
        let legacy_v9 = CognitionRouteRegistry::cancer_research_exploration_legacy_v9();
        assert_eq!(
            legacy_v9.validate(CognitionRoutePurpose::CancerResearchExploration),
            Ok(())
        );
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchExploration,
                legacy_v9.policy_version,
            ),
            Ok(legacy_v9)
        );
        let legacy_v8 = CognitionRouteRegistry::cancer_research_exploration_legacy_v8();
        assert_eq!(
            legacy_v8.validate(CognitionRoutePurpose::CancerResearchExploration),
            Ok(())
        );
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchExploration,
                legacy_v8.policy_version,
            ),
            Ok(legacy_v8)
        );
        ...
        let legacy_escalation = CognitionRouteRegistry::cancer_research_escalation_legacy_v4();
        assert_eq!(
            CognitionRouteRegistry::cancer_research_for_policy(
                CognitionRoutePurpose::CancerResearchEscalation,
                legacy_escalation.policy_version,
            ),
            Ok(legacy_escalation)
        );
        assert!(matches!(
            registry.validate(CognitionRoutePurpose::ProductionWorld),
    ...
    #[test]
    fn cancer_paid_routes_have_an_isolated_treasury() {
        assert_eq!(
