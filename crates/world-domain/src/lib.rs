...
pub use embodiment::{
    ...
    COMPOSITIONAL_SIGNAL_ASSOCIATION_SCHEMA_VERSION, EmbodimentError,
...
pub use event::{
    ...
    COMPETITIVE_SIGNAL_LEARNING_EVENT_SCHEMA_VERSION, COMPOSITIONAL_SIGNAL_EVENT_SCHEMA_VERSION,
    CONFIGURED_EVENT_SCHEMA_VERSION, CONTEMPORANEOUS_SIGNAL_EVENT_SCHEMA_VERSION, CategoryError,
...
pub use research::{
    ...
    CANCER_PATIENT_DERIVED_MOLECULAR_QUALIFICATION_SCHEMA_VERSION,
    ...
    CANCER_VIRTUAL_MECHANISTIC_READOUT_SCHEMA_VERSION, CancerMolecularTarget, CancerNci60CnsLine,
    CancerNci60ObservedRank, CancerNci60ResponsePrediction, CancerNci60ResponseQualification,
    CancerNciInterventionIdentity, CancerPatientDerivedMolecularQualification,
    CancerPatientDerivedTargetObservation, CancerPatientDerivedTargetStatus,
